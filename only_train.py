...
from multi_model import Multimodel_attention_cat_trans
...
def args_parse():
    ...
    parse.add_argument('--model_class', default='text')
...
if __name__ == '__main__':
    ...
    resnet_learning_rate = args.resnet_lr
    ...
    best_accuracy = 0
    val_accuracy = []
    print("消融实验 : only {}".format(only_model))
